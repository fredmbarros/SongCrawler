...
const Home = () => {
	...
	const chooseGreeting = () => {
		let greetingsArr = [
			...
			`Got that itch for music? Hunt that song here`,
			`Wouldn't you like to know a bit more about that song?`,
			`Type in here whatever song that catches your fancy`,
			`Shazam'd some interesting song? Type it here`,
